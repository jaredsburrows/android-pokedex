...
class PokemonInfoScreenTest {
  ...
  private val pokemonInfoScreenTitle by lazy { context.getString(R.string.pokemon_info_screen_title) }
  ...
  @Test
  fun testClickOnPokemonAssertInformation() {
    composeTestRule.onNodeWithText(text = pokemonListScreenTitle).assertIsDisplayed()
    composeTestRule.waitForIdle()

    composeTestRule.onNodeWithText(text = "Bulbasaur").assertIsDisplayed().performClick()
    composeTestRule.waitForIdle()

    composeTestRule.onNodeWithText(text = "$pokemonInfoScreenTitle: Bulbasaur").assertIsDisplayed()
    composeTestRule.waitForIdle()

    composeTestRule.onNodeWithContentDescription(label = "Icon").assertIsDisplayed()

    composeTestRule.onNodeWithText(text = "Number:").assertIsDisplayed()
    composeTestRule.onNodeWithText(text = "Base Experience:").assertIsDisplayed()
    composeTestRule.onNodeWithText(text = "Height:").assertIsDisplayed()
    composeTestRule.onNodeWithText(text = "Weight:").assertIsDisplayed()
    composeTestRule.onNodeWithText(text = "Abilities:").assertIsDisplayed()
    composeTestRule.onNodeWithText(text = "Forms:").assertIsDisplayed()
